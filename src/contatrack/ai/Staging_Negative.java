...
public class Staging_Negative {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * driver.findElement(By.xpath("//button[contains(text(),'+ ADD EMPLOYEE')]")).
		 * click(); driver.findElement(By.xpath("//input[@type='text']")).
		 * sendKeys("Sourav Ganguly"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[2]/div[1]/input[1]")).sendKeys
		 * ("sathisaha.job@gmail.com");
		 * driver.findElement(By.xpath("//input[@placeholder = '1 (702) 123-4567']")).
		 * sendKeys("9874812692");
		 * 
		 * driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[5]/div[1]/input[1]")).sendKeys
		 * ("EMP98"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[6]/div[1]/input[1]")).sendKeys
		 * ("QATester"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[7]/div[1]/input[1]")).sendKeys
		 * ("ITTTT"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[8]/div[1]/div[1]/div[1]/input[1]"
		 * )).click(); Select abhishekyaer = new Select(driver.findElement(By.xpath(
		 * "//select[@class='react-datepicker__year-select']")));
		 * abhishekyaer.selectByValue("1995"); Select abhishekmonth = new
		 * Select(driver.findElement(By.xpath(
		 * "//select[@class='react-datepicker__month-select']")));
		 * abhishekmonth.selectByValue("0"); driver.findElement(By.xpath(
		 * "//div[contains(@class,'react-datepicker__day--009')]")).click(); Select
		 * gender =new
		 * Select(driver.findElement(By.xpath("//*[@class='modal-input']//select")));
		 * gender.selectByIndex(1);
		 * driver.findElement(By.xpath("//button[contains(text(),'Add')]")).click();
		...
		/*
		 * driver.findElement(By.xpath("//button[contains(text(),'+ ADD CAMERA')]")).
		 * click(); driver.findElement(By.xpath(
		 * "/html/body/div[2]/div[3]/div/div[2]/div/div[1]/div/input")).sendKeys(
		 * "Came9990"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[4]/div[1]/input[1]")).sendKeys
		 * ("Meeting"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[5]/div[1]/input[1]")).sendKeys
		 * ("9876"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[6]/div[1]/input[1]")).sendKeys
		 * ("2"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[7]/div[1]/input[1]")).sendKeys
		 * ("4"); driver.findElement(By.xpath(
		 * "//body/div[2]/div[3]/div[1]/div[2]/div[1]/div[8]/div[1]/input[1]")).sendKeys
		 * ("https://contatrack.ai/camera");
		 * driver.findElement(By.xpath("//button[contains(text(),'Add')]")).click();
		 */
		...
		WebElement element = driver
				.findElement(By.xpath("//*[@id=\"page-content-wrapper\"]/div/div/div[2]/div/div[1]/input"));
		...
		Thread.sleep(50000);
		// driver.findElement(By.xpath("//*[@id=\"page-content-wrapper\"]/div/div/div[5]/label/span[1]/span[1]/input")).click();
		driver.findElement(By.xpath(
		...
		/*
		 * driver.findElement( By.xpath(
		 * "//body/div[@id='root']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/input[1]"
		 * )) .sendKeys("abef@gmail.com"); driver.findElement( By.xpath(
		 * "//body/div[@id='root']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[2]/input[1]"
		 * )) .sendKeys("HiHipla"); driver.findElement( By.xpath(
		 * "//body/div[@id='root']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/input[1]"
		 * )) .sendKeys("hipla.io"); driver.findElement( By.xpath(
		 * "//body/div[@id='root']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[4]/input[1]"
		 * )) .sendKeys("9748330781");
		 * 
		 * driver.findElement( By.xpath(
		 * "//body/div[@id='root']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[5]/select[1]"
		 * )).click();
		 * 
		 * 
		 * WebElement country = driver.findElement( By.xpath(
		 * "//body/div[@id='root']/div[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[5]/select[1]"
		 * )); Select Country = new Select(country); Country.selectByIndex(18);
		 * 
		 * driver.findElement(By.xpath("//button[contains(text(),'Submit')]")).click();
		 * driver.findElement(By.xpath("//button[contains(text(),'Ok')]")).click();
		 */
